...
**Actor:** medico  
**Estado:** propuesta  
**Bloqueada por:** Issues #5 y #6; aceptación completa de ADR-007 para datos reales  
...
**Aclaración de alcance:** esta HU corresponde a pacientes reales y datos identificatorios autorizados. La persistencia exclusivamente sintética `PX-DEMO-*` ya fue implementada por HU-038 y no desbloquea este alcance clínico.
